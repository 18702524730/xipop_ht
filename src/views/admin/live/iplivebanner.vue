...
<div class="clouditembox">
    <h3 class="ptitle">IP直播banner <span class="addbtn" @click="openadd">添加</span></h3>
    <div class='tablebox'>
  <el-table
    ref="multipleTable"
    :data="dataList"
  ...
  <el-dialog :title="title" :visible.sync="isopen">
    <div class="openbox">
      <el-form label-width="100px" :model="formdata" label-position="right" :rules="rules" ref="formdatas">
          ...
          <el-form-item label="广告链接：" prop="advertisementLink">
...
<script>
const addurl = '/api/pictorial/updateIpAdvertisementBanner'
const delurl = '/api/pictorial/deleteIpAdvertisementBanner'
const listurl = '/api/pictorial/selectIpAdvertisementBanner'
  ...
  export default {
    ...
    methods: {
      ...
      addone(){
        ...
        data.advertisementPlace = 'IP直播banner'
