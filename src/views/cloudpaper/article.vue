<template>
  <div class="articlecont" :class="{haspd: from ==1}">
      <div v-if="from==2" class="fromadmin">
          <h3>查看文章 <span @click="pagerefresh"><i class="el-icon-refresh"></i> 刷新</span><span @click="toback"><i class="el-icon-close"></i> 关闭</span></h3>
      </div>
